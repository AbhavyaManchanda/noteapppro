...
function Note( {note,index,hight}) {
  ...
  return (
    ...
    <div className="note relative" id={`note${index}`}>
        ...
        <h1 className='text-[black] text-[20px] w-[80%]'>{note.title}</h1>
        <p className='text-[grey] w-[80%] line-clamp-4'>{note.desc}</p>
...

    {
                ...
                <div className="deleteNoteModelCon flex items-center justify-center flex-col fixed top-0 left-0 w-screen h-screen  bg-[rgb(0,0,0,.2)] z-[100]">
                    <div className='deleteNoteModelBody relative p-[15px] w-[40vw] h-[25vh] rounded-md bg-[#fff] shadow-lg'>
                        ...
                        <p className='m-0 p-0 text-[grey] ' >Do you want to Delete This Noot <br/> Yes / No </p>
